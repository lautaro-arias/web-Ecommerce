...
import useProductHandler from './handler/products'
    ...
    <div className="container mb-4">
        <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4  row-cols-xl-4">
              ...
              <div className="col mt-2" key={index}>
                  <div className="card">
                    <img  src={require(`../../assets/produsctSeason/${imgProductSeason[index]}`)} className="card-img-top img-product-home" alt="indumentaria"/>
