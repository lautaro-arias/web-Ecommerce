    ...
    <div className="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex-="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
                ...
                <div className="offcanvas-body text-start">
                            ...
                            <ul className="flex-column mt-4">
                                <li className="p-0 text-dark mb-2 fs-5 fw-bold">Guia de talles</li>
                                <li className="p-0 text-dark mb-2 fs-5 fw-bold">Contacto</li>
                                <li className="p-0 text-dark mb-2 fs-5 fw-bold">Preguntas frecuentes</li>
                                <li className="p-0 text-dark mb-2 fs-5 fw-bold">Politicas</li>
                            </ul>
                </div>
    </div>
)
